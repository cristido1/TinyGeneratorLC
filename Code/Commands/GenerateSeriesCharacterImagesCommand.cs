...
{
    public sealed class GenerateSeriesCharacterImagesCommand : ICommand
    {
        ...
        public async Task<ImageGenerationSummary> ExecuteAsync(string runId, CancellationToken ct)
        {
            ...
            if (total == 0)
            {
                ...
                _logger.Log("Information", "SeriesCharacterImages", "[0]/[0] Nessuna immagine da generare");
                if (_characterId.HasValue)
                {
            ...
            for (var i = 0; i < total; i++)
            {
                ...
                var current = i + 1;
                _logger.Log("Information", "SeriesCharacterImages", $"[{current}]/[{total}] Genera immagini personaggi");
            ...
            _logger.Log("Information", "SeriesCharacterImages", $"[{total}]/[{total}] Completato");
