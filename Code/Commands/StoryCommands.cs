...
{
    public interface IStoryCommand : ICommand
    {
        Task<CommandResult> ExecuteAsync(CancellationToken ct = default);
    }

    public sealed class CreateStoryCommand : IStoryCommand, ICommand
    {
        ...
        public Task<CommandResult> ExecuteAsync(CancellationToken ct = default)
        {
            ...
            var message = string.IsNullOrWhiteSpace(chainId)
                ? $"Storia creata (id={id})"
                : $"Storia creata (id={id}) - catena stati avviata ({chainId})";
            return Task.FromResult(new CommandResult(true, message));
        }
    }

    public sealed class EvaluateStoryCommand : IStoryCommand, ICommand
    {
        private readonly StoriesService _stories;
    ...
    public sealed class EvaluateCoherenceCommand : IStoryCommand, ICommand
    {
        private readonly StoriesService _stories;
        private readonly long _storyId;
        private readonly int _agentId;
    ...
    public sealed class EvaluateActionPacingCommand : IStoryCommand, ICommand
    {
        private readonly StoriesService _stories;
        private readonly long _storyId;
        private readonly int _agentId;
    ...
    public sealed class GenerateTtsSchemaCommand : IStoryCommand, ICommand
    {
        private readonly StoriesService _stories;
        private readonly long _storyId;
    ...
    public sealed class GenerateTtsVoiceCommand : IStoryCommand, ICommand
    {
        private readonly StoriesService _stories;
        private readonly long _storyId;
    ...
    /// </summary>
    public sealed class StoryStubCommand : IStoryCommand, ICommand
    {
