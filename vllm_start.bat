...
set "MODEL_SUBDIR=Vishva007--Qwen3.5-9B-W4A16-AutoRound-AWQ"
set "MODEL_PATH=%CONTAINER_MODELS_PATH%/%MODEL_SUBDIR%"
set "TOKENIZER_SUBDIR=Vishva007--Qwen3.5-9B-W4A16-AutoRound-AWQ"
set "TOKENIZER_PATH=%CONTAINER_MODELS_PATH%/%TOKENIZER_SUBDIR%"
set "SERVED_MODEL_NAME=Vishva007/Qwen3.5-9B-W4A16-AutoRound-AWQ"
set "MONOMODEL_DESCRIPTION=Vishva007/Qwen3.5-9B-W4A16-AutoRound-AWQ"
set "APPSETTINGS_PATH=%~dp0appsettings.json"

REM Parametri runtime
set "GPU_MEMORY_UTIL=0.88"
set "MAX_MODEL_LEN=4096"
set "MAX_NUM_SEQS=1"
set "MAX_NUM_BATCHED_TOKENS=1024"
